...
const ShippingInformation = () => {
  ...
  const setErrorState = (input, data) => {
    ...
    if ((!formChangeState && !input) || (formChangeState && input)) {
      return;
    } else {
      setFormChangeState(input);
    ...
    <Formik
      ...
      validationSchema={Yup.object({
        address: Yup.string()
          ...
          .min(2, "This address is to short."),
        postalCode: Yup.string()
          .required("This field is required.")
          .min(2, "This postal code is to short."),
        city: Yup.string()
          .required("This field is required.")
          .min(2, "This city is to short."),
        country: Yup.string()
          .required("This field is required.")
          .min(2, "This country is to short."),
      })}
    >
      {(formik) => (
        <VStack as="form">
              ...
              >
                ...
                <Radio value="false">
                  <Tooltip label="Free shipping for orders of $1000 or more!">
                    <Box>
                      <Text fontWeight="bold">Standart $4.99</Text>
